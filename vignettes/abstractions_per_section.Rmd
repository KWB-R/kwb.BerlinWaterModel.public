...
input_list_bfs_static <- kwb.BerlinWaterModel::prepare_input(temporal_resolution = temporal_resolution,
                                             config = config,
                                             cso = cso,
                                             inflows = inflows,
...
input_list_bfs_dynamic <- kwb.BerlinWaterModel::prepare_input(temporal_resolution = temporal_resolution,
                                                        config = config,
                                                        cso = cso,
                                                        inflows = inflows,
                                                        share_wwtp_sch_panke_1 = 0.1,
...
system.time(
  flows_bfs_static <- kwb.BerlinWaterModel::calculate_flows_auto(config = config,
...
system.time(
  flows_bfs_dynamic <- kwb.BerlinWaterModel::calculate_flows_auto(config = config,
...
plots <- kwb.BerlinWaterModel::plot_flows_and_bfshares_per_section(config = config,
                                                                flows = flows,
                                                                network = network,
                                                                ww = ww,
