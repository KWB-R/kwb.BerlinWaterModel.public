...
#> Section starting concentrations missing for: conc_Fluoranthen.mg.m3
#> 0 will be assumed as starting concentration for all 'sections'!
...
input_list_bfs_static <- kwb.BerlinWaterModel.public::prepare_input(temporal_resolution = temporal_resolution,
                                             ...
                                             date_min = "2002-01-01",
                                             date_max = "2022-12-31")
#> Adding DWD rain data and aggregate from 'hourly' to 'daily' values and convert from 'mm/h' to 'm3/s' ... ok. (0.10 secs) 
...
input_list_bfs_dynamic <- kwb.BerlinWaterModel.public::prepare_input(temporal_resolution = temporal_resolution,
                                                        ...
                                                        date_min = "2002-01-01",
                                                        date_max = "2022-12-31")
#> Adding DWD rain data and aggregate from 'hourly' to 'daily' values and convert from 'mm/h' to 'm3/s' ... ok. (0.04 secs) 
#> Checking multiple outflows (i.e. 'share_Panke_to_BSSKanal', 'share_Panke_to_Nordgraben') time series for section 'Panke' (1/1) ... ok. (0.00 secs)
```
...
#> Calculating flow for section 'Erpe (NH-MF)' ... ok. (0.08 secs) 
...
#> ok. (0.14 secs) 
#> Calculating flow for section 'Oberhavel 1' ... ok. (0.11 secs) 
#> Calculating flow for section 'Spree 4' ...
#> use dynamic & function for flow from section 'Spree 3' to 'Spree 4'
#> ok. (0.15 secs) 
#> Calculating flow for section 'Tegeler Fließ' ... ok. (0.11 secs) 
...
#> ok. (0.15 secs) 
#> Calculating flow for section 'Oberhavel 2' ... ok. (0.11 secs) 
#> Calculating flow for section 'Spree 5' ... ok. (0.11 secs) 
#> Calculating flow for section 'Tegeler See' ... ok. (0.13 secs) 
#> Calculating flow for section 'Teltowkanal 2' ... ok. (0.12 secs) 
#> Calculating flow for section 'Oberhavel 3' ... ok. (0.10 secs) 
#> Calculating flow for section 'Spree 6' ... ok. (0.11 secs) 
#> Calculating flow for section 'Teltowkanal 3' ... ok. (0.11 secs) 
#> Calculating flow for section 'Unterhavel 1' ... ok. (0.11 secs) 
#> Calculating flow for section 'Wannsee' ...
#> use dynamic & function for flow from section 'Teltowkanal 3' to 'Wannsee'
#> ok. (0.14 secs) 
#> Calculating flow for section 'Unterhavel 2' ... ok. (0.12 secs)
#>    user  system elapsed 
#>    5.99    0.21    6.69
...
#> Calculating flow for section 'Müggelspree 2' ... ok. (0.09 secs) 
#> Calculating flow for section 'Dahme' ... ok. (0.09 secs) 
#> Calculating flow for section 'MHG-Graben' ... ok. (0.08 secs) 
#> Calculating flow for section 'Müggelspree' ... ok. (0.09 secs) 
...
#> Running for id 1/35 (S04: Müggelsee) ... ok. (0.45 secs) 
...
#> ok. (0.00 secs) 
#> Running for id 22/35 (H04: Oberhavel 1) ... ok. (0.42 secs) 
...
#> Running for id 28/35 (H03: Tegeler See) ... ok. (0.55 secs) 
...
#> Running for id 35/35 (H08: Unterhavel 2) ... ok. (0.52 secs) 
#> [[1]]
#> 
#> [[2]]
#> 
...
#> 
#> Running for id 1/35 (S04: Müggelsee) ... ok. (0.45 secs) 
#> Running for id 2/35 (S01: Seddinsee und Gosener Kanal) ... ok. (0.45 secs) 
#> Running for id 3/35 (S06: Erpe (NH-MF)) ... ok. (0.42 secs) 
...
#> No outflow to well gallery or managed aquifer recharge for section Müggelspree (S05)
#> ok. (0.00 secs) 
#> Running for id 9/35 (S08: Wuhle) ... ok. (0.57 secs) 
#> Running for id 10/35 (S11: Rummelsburger See) ...
#> No outflow to well gallery or managed aquifer recharge for section Rummelsburger See (S11)
#> ok. (0.00 secs) 
...
#> No outflow to well gallery or managed aquifer recharge for section Teltowkanal 1 (S22)
#> ok. (0.00 secs) 
#> Running for id 26/35 (H05: Oberhavel 2) ... ok. (0.48 secs) 
...
#> (`geom_point()`).
#> 
#> Running for id 1/35 (S04: Müggelsee) ... ok. (0.43 secs) 
...
#> ok. (0.00 secs) 
#> Running for id 26/35 (H05: Oberhavel 2) ... ok. (0.49 secs) 
#> Running for id 27/35 (S19: Spree 5) ... ok. (0.64 secs) 
...
#> (`geom_point()`).
#> 
#> Running for id 1/35 (S04: Müggelsee) ... ok. (0.50 secs) 
#> Running for id 2/35 (S01: Seddinsee und Gosener Kanal) ... ok. (0.39 secs) 
#> Running for id 3/35 (S06: Erpe (NH-MF)) ... ok. (0.36 secs) 
#> Running for id 4/35 (S02: Langer See (Dahme)) ... ok. (0.56 secs) 
#> Running for id 5/35 (S05a: Müggelspree 2) ...
#> No outflow to well gallery or managed aquifer recharge for section Müggelspree 2 (S05a)
#> ok. (0.00 secs) 
#> Running for id 6/35 (S03: Dahme) ...
...
#> No outflow to well gallery or managed aquifer recharge for section Müggelspree (S05)
#> ok. (0.00 secs) 
#> Running for id 9/35 (S08: Wuhle) ... ok. (0.43 secs) 
#> Running for id 10/35 (S11: Rummelsburger See) ...
#> No outflow to well gallery or managed aquifer recharge for section Rummelsburger See (S11)
#> ok. (0.00 secs) 
...
#> Running for id 2/35 (S01: Seddinsee und Gosener Kanal) ... ok. (0.43 secs) 
#> Running for id 3/35 (S06: Erpe (NH-MF)) ... ok. (0.37 secs) 
#> Running for id 4/35 (S02: Langer See (Dahme)) ... ok. (0.38 secs) 
#> Running for id 5/35 (S05a: Müggelspree 2) ...
#> No outflow to well gallery or managed aquifer recharge for section Müggelspree 2 (S05a)
...
#> No outflow to well gallery or managed aquifer recharge for section Rummelsburger See (S11)
#> ok. (0.00 secs) 
#> Running for id 11/35 (S07: Spree 1) ... ok. (0.48 secs) 
#> Running for id 12/35 (S12: Britzer Verbindungskanal) ...
#> No outflow to well gallery or managed aquifer recharge for section Britzer Verbindungskanal (S12)
#> ok. (0.00 secs) 
#> Running for id 13/35 (S21a: Rudower Teltowkanal 1) ...
...
#> No outflow to well gallery or managed aquifer recharge for section Nordgraben (H01)
#> ok. (0.00 secs) 
#> Running for id 22/35 (H04: Oberhavel 1) ... ok. (0.90 secs) 
#> Running for id 23/35 (S17: Spree 4) ...
#> No outflow to well gallery or managed aquifer recharge for section Spree 4 (S17)
#> ok. (0.00 secs) 
#> Running for id 24/35 (H02: Tegeler Fließ) ...
...
#> No outflow to well gallery or managed aquifer recharge for section Teltowkanal 1 (S22)
#> ok. (0.00 secs) 
#> Running for id 26/35 (H05: Oberhavel 2) ... ok. (0.60 secs) 
#> Running for id 27/35 (S19: Spree 5) ... ok. (0.77 secs) 
#> Running for id 28/35 (H03: Tegeler See) ... ok. (0.59 secs) 
#> Running for id 29/35 (S22a: Teltowkanal 2) ...
#> No outflow to well gallery or managed aquifer recharge for section Teltowkanal 2 (S22a)
#> ok. (0.00 secs) 
#> Running for id 30/35 (H06: Oberhavel 3) ...
...
#> Running for id 35/35 (H08: Unterhavel 2) ... ok. (0.50 secs) 
#> [[1]]
#> 
#> [[2]]
#> 
...
#> Running for id 2/35 (S01: Seddinsee und Gosener Kanal) ... ok. (0.57 secs) 
#> Running for id 3/35 (S06: Erpe (NH-MF)) ... ok. (0.35 secs) 
#> Running for id 4/35 (S02: Langer See (Dahme)) ... ok. (0.36 secs) 
#> Running for id 5/35 (S05a: Müggelspree 2) ...
#> No outflow to well gallery or managed aquifer recharge for section Müggelspree 2 (S05a)
#> ok. (0.00 secs) 
#> Running for id 6/35 (S03: Dahme) ...
